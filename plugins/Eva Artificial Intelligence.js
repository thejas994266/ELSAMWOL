...
if (conf.LANG == 'EN') vtalk_dsc = 'Starts to ElsaMwol voice chat.', reply_eva = '*Reply to Any Voice Message!*'
...
var succ_off = ''
if (conf.LANG == 'TR') {
    fulleva_dsc = 'Tam fonksiyonel ElsaMwol özelliklerini aktif eder. Hesabınızı bir chatbota dönüştürün!'
    already_on = 'ElsaMwol yapay zekası halihazırda tüm fonksiyonları etkin.'
    already_off = 'ElsaMwol yapay zekası halihazırda yarı fonksiyonel çalışıyor.'
    succ_on = 'ElsaMwol, Tam Fonksiyonel Olarak Açıldı! Lütfen Biraz Bekleyin! ✅'
    succ_off = 'ElsaMwol, Yarı Fonksiyonel Olarak Ayarlandı! Lütfen Biraz Bekleyin! ☑️'
}
if (conf.LANG == 'EN') {
    fulleva_dsc = 'Activates full functional Pikachu features. Turn your account into a ai chatbot!'
    already_on = 'ElsaMwol artificial intelligence is already fully functional.'
    already_off = 'ElsaMwok artificial intelligence is currently running semi-functional.'
    succ_on = 'ElsaMwol Opened Fully Functionally! Please wait a bit! ✅'
    succ_off = 'ElsaMwol Set to Semi-Functional! Please wait a bit! ☑️'
}
if (conf.LANG == 'ML') {
