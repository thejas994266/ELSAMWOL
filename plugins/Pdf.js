...
let toxicdevil = Config.WORKTYPE == 'public' ? false : true
   ...
   Julie.addCommand({pattern: 'pdf ?(.*)', fromMe: toxicdevil, desc: 'Converts Site to PDF.' }, (async (message, match) => {
    ...
    await message.sendMessage(Buffer.from(webimage.data), MessageType.document, {mimetype: Mimetype.pdf, filename: 'Elsa-Mwol.pdf'});
