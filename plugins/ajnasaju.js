...
const SPIDERMAN= require('../events');
const config = require('../config');
const {MessageType, MessageOptions, Mimetype} = require('@adiwajshing/baileys');
const axios = require('axios');
const hrs = new Date().getHours({ timeZone: 'Asia/Kolkata' })

Elsa.addCommand({pattern: 'git ?(.*)', fromMe: false, desc: 'it send bot menu'}, (async (message, match) => {
...
*Bot making video* : https://youtu.be/L8E4enqfYik



*githublink* : https://github.com/SKDRAGON1/ELSAMWOL
