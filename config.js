...
module.exports = {
    ...
    GIF_WEL: process.env.GIF_WEL === undefined ? 'https://i.imgur.com/zoIIvOk.mp4' : process.env.GIF_WEL,
    GIF_BYE: process.env.GIF_BYE === undefined ? 'false' : process.env.GIF_BYE,
    BGMFILTER: process.env.BGM_FILTER === undefined ? false : convertToBool(process.env.BGM_FILTER),
    DISBGM: process.env.DISABLE_JID_BGM_FILTER === undefined ? false : process.env.DISABLE_JID_BGM_FILTER,
    NOLOG: process.env.NO_LOG === undefined ? 'false' : process.env.NO_LOG,
    SAID: process.env.BGM_DURATION === undefined ? '999999' : process.env.BGM_DURATION,
    FULLEVA: process.env.FULL_EVA === undefined ? 'false' : process.env.FULL_EVA,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? '𝐄𝐋𝐒𝐀 𝐌𝐖𝐎𝐋࿐' : process.env.BOT_NAME,
