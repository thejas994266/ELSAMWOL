...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? '*𝐌𝐀𝐊𝐄𝐃 𝐁𝐘 𝐄𝐋𝐒𝐀 𝐌𝐖𝐎𝐋࿐*' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '917736936605@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOT: process.env.BOT_NAME === undefined ? '𝐄𝐋𝐒𝐀 𝐌𝐖𝐎𝐋࿐' : process.env.BOT_NAME,
    ...
    WEL_GIF: process.env.WEL_GIF === undefined ? 'https://i.imgur.com/5KIYIl9.mp4' : process.env.WEL_GIF,
